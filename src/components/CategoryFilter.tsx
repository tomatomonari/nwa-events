    ...
    <div className="flex gap-3">
      ...
      >
        ...
        <div className="text-left">
          ...
          <div className={`text-xs ${selected === "business" ? "text-white/70" : "text-muted-foreground"}`}>{businessCount} events</div>
        </div>
      </button>
      ...
      >
        ...
        <div className="text-left">
          ...
          <div className={`text-xs ${selected === "fun" ? "text-white/70" : "text-muted-foreground"}`}>{funCount} events</div>
        </div>
      </button>
    </div>
  );
